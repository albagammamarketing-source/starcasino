...
# =========================================================
    ...
    st.info(
        "Nuova promozione STARCASINO. "
        "La logica di estrazione e i relativi filtri saranno configurati "
        "nel modulo dedicato promo_5evetswin.py."
    )

    st.write(
        "Questa sezione è già predisposta nel menu principale. "
        "Nel prossimo step verranno aggiunti i filtri, le regole di estrazione "
        "e il CSV specifico della promozione 5evetsWin."
    )
